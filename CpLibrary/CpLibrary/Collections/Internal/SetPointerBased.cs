...
public class SetPointerBased<T> : IEnumerable<T> where T : IComparable<T>
{
	Node root;
	...
	public SetPointerBased(bool isMultiSet = false) : this(Comparer<T>.Default, isMultiSet) { }
	public SetPointerBased(IComparer<T> comparer, bool isMultiSet = false)
	{
	...
	public SetPointerBased(IList<T> list, bool isMultiSet = false) : this(list, Comparer<T>.Default, isMultiSet) { }
	public SetPointerBased(IList<T> list, IComparer<T> comparer, bool isMultiSet = false) : this(comparer, isMultiSet)
	{
		root = Build(list, 0, list.Count);
	}
	public SetPointerBased(Comparison<T> comparison, bool isMultiSet = false) : this(Comparer<T>.Create(comparison), isMultiSet) { }
	public SetPointerBased(IList<T> list, Comparison<T> comparison, bool isMultiSet = false) : this(list, Comparer<T>.Create(comparison), isMultiSet) { }
	...
	public T this[int index]
	{
		get
		{
			Debug.Assert((uint)root.Count > (uint)index);
